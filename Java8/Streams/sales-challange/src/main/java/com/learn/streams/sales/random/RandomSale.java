...
import com.learn.streams.sales.Item;
import com.learn.streams.sales.Sale;
import com.learn.streams.sales.Store;
...
import static com.learn.streams.sales.random.RandomUtil.randomElement;
...
public class RandomSale {
  ...
  private static List<Item> randomListOfItems() {
    ...
    List<Item> items = RandomItems.infiniteStream()
            .limit(howMany)
